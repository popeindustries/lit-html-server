...
declare const defaultTemplateResultProcessor: DefaultTemplateResultProcessor;
 ...
 */
declare function directive<F extends (...args: Array<any>) => object>(f: F): F;

/**
 * Determine if "fn" is a directive function
 */
declare function isDirective(fn: unknown): fn is Function;

/**
 * Determine if "part" is an AttributePart
 */
declare function isAttributePart(part: unknown): part is AttributePart;

/**
 * Determine if "part" is a NodePart
 */
declare function isNodePart(part: unknown): part is NodePart;

/**
 * Determine whether "result" is a TemplateResult
 */
declare function isTemplateResult(result: unknown): result is TemplateResult;

/**
 * A value for strings that signals a Part to clear its content
 */
declare const nothingString: string;
declare const templateCache: Map<TemplateStringsArray, Template>;

/**
 * A prefix value for strings that should not be escaped
 */
declare const unsafePrefixString: string;

/**
 * Interprets a template literal as an HTML template that can be
 * rendered as a Readable stream or String
 */
declare function html(strings: TemplateStringsArray, ...values: Array<unknown>): TemplateResult;
declare function svg(strings: TemplateStringsArray, ...values: Array<unknown>): TemplateResult;

/**
 * Render a template result to a string resolving Promise.
 */
declare function renderToString(result: TemplateResult, options?: RenderOptions): Promise<string>;
 ...
 */
declare function renderToBuffer(result: TemplateResult, options?: RenderOptions): Promise<Buffer>;
 ...
 */
declare class PropertyAttributePart extends AttributePart {
  /**
 ...
 */
declare class EventAttributePart extends AttributePart {
  /**
   * Retrieve resolved string Buffer from passed "values".
