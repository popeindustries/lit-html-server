...
const { isPromise, isSyncIterator } = require('./is.js');
const { emptyArray, removeHeader, sanitize } = require('./string.js');
 ...
 */
module.exports = function asyncHtmlTemplate(strings, ...values) {
